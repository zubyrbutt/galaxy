...
Route::group(['prefix'=> 'leads'],function(){
    ...
    Route::post('/store_appnote', 'LeadController@store_appnote')->middleware('auth','ipcheck')->name('store_appnote');

    Route::post('/store_appointment_note', 'AppointmentController@store_appointment_note')->middleware('auth','ipcheck')->name('store_appointment_note');
...
Route::get('/allappointments', 'AppointmentController@allappointments')->middleware('can:leads-appointments')->name('allappointments');
Route::post('appointmentfilter', 'AppointmentController@appointmentfilter')->middleware('can:appointment-filter')->name('appointmentfilter');
...
Route::get('/leads/create_appointment_note/{id}/{app_id}', 'AppointmentController@create_appointment_note')->middleware('auth','ipcheck')->name('create_appointment_note');
