    ...
    <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="total_leads"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="New"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="Inprocess"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="Callback"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
         ...
         <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="TrialCommitted"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="TrialDelivered"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Invoice Sent</span>
              <span class="info-box-number" id="InvoiceSent"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-red"><i class="fa fa-file-audio-o"></i></span>
         ...
         <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="Rejected"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
         ...
         <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="NotInterested"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <!-- /.col -->
         <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">NSNC</span>
              <span class="info-box-number" id="NSNC"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
           ...
           "ajax":{
             ...
             "complete": function(xhr, responseText){
                 //myJSON = JSON.stringify(xhr);
                    console.log(xhr);
                    console.log(xhr.responseJSON.dataStatus.Total_leads);
                    var status = xhr.responseJSON.dataStatus;
                    $('#total_leads').html(status.Total_leads);
                    $('#New').html(status.New);
                    $('#Inprocess').html(status.Inprocess);
                    $('#Closed').html(status.Closed);
                    $('#Rejected').html(status.Rejected);
                    $('#NotInterested').html(status.NotInterested);
                    $('#Callback').html(status.Callback);
                    $('#TrialCommitted').html(status.TrialCommitted);
                    $('#TrialDelivered').html(status.TrialDelivered);
                    $('#InvoiceSent').html(status.InvoiceSent);
                    $('#Spam').html(status.Spam);
                    $('#NSNC').html(status.NSNC);
                    $('#Duplicate').html(status.Duplicate);
