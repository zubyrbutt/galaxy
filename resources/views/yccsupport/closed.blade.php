...
<div class=WordSection1>
    ...
    <p class=MsoNormal>Your Ticked with ID # {{ $emaildata[0]['yccsupport_id']  }} has now been closed. We hope that, we addressed your concern / issue to your satisfaction. Feel free to reach out to us again if you need any further help.

    Kindly Mark this ticket as resolved by visiting following link: </p>

    <p class=MsoNormal>&nbsp;</p>
    <p class=MsoNormal><b><u>Close Ticket URL</u>:  </b><a
            href="{{ route('yccsupport-close-ticket',$emaildata[0]['yccsupport_id']) }}">{{ route('yccsupport-close-ticket',$emaildata[0]['yccsupport_id']) }}</a>
    </p>
    <br>
    ...
    <p class=MsoNormal><b><u>Status</u>: </b>Closed</p>
