...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     user experience. -->
     <!-- page script -->
@if (\Request::is('admins') or \Request::is('roles')  or \Request::is('projects') or \Request::is('categories') or \Request::is('menu') or \Request::is('customers') or \Request::is('leads') or \Request::is('callbackfilter')  or \Request::is('appointmentfilter')  or \Request::is('allappointments')  or Route::currentRouteName()=='leads.show' or \Request::is('recordings') or Route::currentRouteName()=="appointments.index" or Route::currentRouteName()=="appointments" or Route::currentRouteName()=="callbacks" or Route::currentRouteName()=="recordings.index" or Route::currentRouteName()=="recordings"  or Route::currentRouteName()=="tasks" or \Request::is('dashboard') or Route::currentRouteName()=='leads.search' or Route::currentRouteName()=='callbacksearch' or \Request::is('chapters') or \Request::is('topics') or Route::currentRouteName()=="departments" or Route::currentRouteName()=="leads.indexmain"  or Route::currentRouteName()=="teacher_course.index" or Route::currentRouteName()=="teacher_timing.index" or Route::currentRouteName()=="parents.studentformparent" or Route::currentRouteName()=="daily_schedule.index" or Route::currentRouteName()=="daily_schedule.search" or Route::currentRouteName()=="daily_schedule.classDetails" or Route::currentRouteName()=="daily_schedule.classDetailsSearch" or Route::currentRouteName()=="invoice.index" or Route::currentRouteName()=="invoicelist.index"  or Route::currentRouteName()=='invoicelist.indexSearch'  or Route::currentRouteName()=="schedule.index")
