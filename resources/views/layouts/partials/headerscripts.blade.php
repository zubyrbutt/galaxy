...
@if (Route::currentRouteName()=='leads.index' or Route::currentRouteName()=='callbackfilter'or  Route::currentRouteName()=='callbacksearch'  or Route::currentRouteName()=='leads.search' or Route::currentRouteName()=='createappointments' or Route::currentRouteName()=='hrleads' or Route::currentRouteName()=='createcallback' or Route::currentRouteName()=='interviewees' or Route::currentRouteName()=='interviews'  or Route::currentRouteName()=='admins.create' or Route::currentRouteName()=='admins.edit'  or Route::currentRouteName()=='activitylogs'  or Route::currentRouteName()=='daily_schedule.classDetails' or Route::currentRouteName()=='daily_schedule.classDetailsSearch' or Route::currentRouteName()=='invoicelist.index' or Route::currentRouteName()=='invoicelist.indexSearch' )
  <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.9.0/moment-with-locales.js"></script>
  <script src="{{ asset('bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
  <link href="{{ asset('bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
@endif
<!-- For Select2 -->
@if (Route::currentRouteName()=='leads.index' or Route::currentRouteName()=='callbackfilter' or Route::currentRouteName()=='callbacksearch' or Route::currentRouteName()=='leads.search' or Route::currentRouteName()=='createappointments' or Route::currentRouteName()=='callbackfilter' or Route::currentRouteName()=='createcallback' or Route::currentRouteName()=='leads.edit' or Route::currentRouteName()=='teacher_course.create' or Route::currentRouteName()=='teacher_timing.create' or Route::currentRouteName()=='student' or Route::currentRouteName()=='schedule.create' or Route::currentRouteName()=='daily_schedule.index' or Route::currentRouteName()=='daily_schedule.search' or Route::currentRouteName()=='daily_schedule.classDetails' or Route::currentRouteName()=='daily_schedule.classDetailsSearch' or Route::currentRouteName()=='makeinvoicepayment' or Route::currentRouteName()=='invoicelist.index' or Route::currentRouteName()=='invoicelist.indexSearch'  )
