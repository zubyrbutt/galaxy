            ...
            @if(count($projects) > 0)
              <table id="example1" class="display responsive nowrap" style="width:100%">
                ...
                @foreach($projects as $project)
                  <tr>
                    <td><a href="{!! url('/customer/projects/'.$project['id'] ); !!}">{{$project['id']}}</a></td>
                    ...
                    <td>
                      <a href="{!! url('/customer/projects/'.$project['id'] ); !!}" class="btn btn-primary" title="View Detail"><i class="fa fa-eye"></i> </a>    
                     {{-- <a href="{!! url('/customer/projects/'.$project['id'].'/edit'); !!}"  class="btn btn-success" title="Edit"><i class="fa fa-edit"></i> </a>
                     --}}                     
                    </td>
                  </tr>
                  @endforeach			  
