...
.kv-reqd {
    ...
    <div class="box box-info">
            ...
            <form class="form-horizontal" action="{!! url('/categories/1/edit'); !!}" method="get" enctype="multipart/form-data">
            @csrf
            <div class="box-body" >
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Category Name" value="Led Tvs" require >
                    @if ($errors->has('name'))
                          <span class="text-red">
