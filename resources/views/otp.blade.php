...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg text-red">Please enter your <b>OTP</b> to proceed further.<br><b>OTP</b> has been sent on your registered mobile number and email address.</p>
