            ...
            <div class="box-header with-border">
              ...
              <span class="pull-right">
                  @if(!empty($userendservicechecklists))
                   <!-- <li class="fa fa-folder btn btn-danger"></li>-->
                  @endif
            ...
            <div class="row">
              ...
              <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{{$user->staffdetails->dob->format('d-M-Y')}}</td>
                </tr>
                <tr>
                    <td><b>CNIC</b></td>
                ...
                <tr>
                  <td><b>Gender</b></td>
                  <td>{{ucfirst($user->staffdetails->gender)}}</td>
              </tr>
              @if(!empty($userendservicechecklists))
                <tr class="text-red">
                  <td><b>Service Ending Date</b></td>
                  <td><b>{{$user->staffdetails->endingdate->format('d-M-Y')}}</b></td>
                </tr>
              @endif
                <tr>
                    <td><b>Status</b></td>
  ...
  <div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Staff Checklist</h4>
        </div>
        <div class="modal-body">
          <table class="table table-bordered">
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="radio" value="yes" name="checklist[{{$checklist->id}}]">
              </td>
              <td>
                <input type="radio" value="no" name="checklist[{{$checklist->id}}]">
              </td>
              <td>
                <input type="radio" value="n/a" name="checklist[{{$checklist->id}}]">
              </td>
            </tr>
            @endforeach
          </table>
          ...
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td>
                ...
                <input type="radio" value="yes" name="endchecklist[{{$endchecklist->id}}]">
              </td>
              <td>
                <input type="radio" value="no" name="endchecklist[{{$endchecklist->id}}]">
              </td>
              <td>
                <input type="radio" value="n/a" name="endchecklist[{{$endchecklist->id}}]">
              </td>
            </tr>
            @endforeach
          </table>
  ...
  <div id="endserviceModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Staff End Service Checklist</h4>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label>Type</label>
          ...
          <div class="form-group">
            <label>Reason</label>
            <textarea class="form-control" placeholder="Reason of End Service" name="reason"></textarea>
          </div>
          <div class="form-group">
            <label>End Service Date</label>
          ...
          success: function(data)
            {
                ...
                if(data.errors)
                {
                  ...
                  $(".loading").fadeOut();
                  swal("Failed", "Unable to update, " + data.errors , "error");
                }
                else
                {
                  $('#modal-default-edit').modal('toggle');
