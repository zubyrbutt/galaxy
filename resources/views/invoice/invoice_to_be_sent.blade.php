...
<tr style="line-height:20px;">
	...
	<a  href="https://erp.nsol.sg/parents/create_invoice_detail_without_login?invoice_id=<?php echo $invoice_id; ?>">
...
<tr>
	<td  style="">
		<a href="https://erp.nsol.sg/parents/print_invoice?invoice_id=<?php echo $invoice_id; ?>" target="_blank" class="button">Print Invoice</a>
	</td>
	<td  style="float:right">
		<a href="https://erp.nsol.sg/parents/downloadpdf?invoice_id=<?php echo $invoice_id; ?>" target="_blank" class="buttondownload">Download PDF</a>
	</td>	
</tr>
