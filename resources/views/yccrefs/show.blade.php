...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Reference Details of {{$lead_detail->name}}</h3>
	        </div>
            <!-- /.box-header -->
				<div class="box-body" >
				  <div class="row">
					...
					<h3>Lead Information:</h3>
					  ...
					  <div class="col-md-12">
						...
						<tr>
							<td><b>Shift</b></td>
							<td>{{$lead_detail->shift}}</td>
						</tr>
						<tr>
							<td><b>Ref By</b></td>
							<td>{{$lead_detail->user->fname}} {{$lead_detail->user->lname}}</td>
						</tr>
						<tr>
							<td><b>Source</b></td>
						...
						<tr>
							...
							<tr>
								...
								<td>{{$lead_detail->updated_at->format('d-M-Y  H:i:s')}}</td>
							</tr>				
			...
			<div class="box-footer">
				<a href="{{ url('yccref') }}" class="btn btn-default">Back</a>              
			</div>
			<!-- /.box-footer -->
</div>
