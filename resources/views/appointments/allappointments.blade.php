...
@section('content')
    ...
    @can('search-leads')
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" action="{!! url('appointmentfilter'); !!}" method="post" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Today Interested in Webinar</h3>
                    @can('create-lead')
                        <span class="pull-right">
{{--              <a href="{!! url('/appointments/'.$leads['id']); !!}" class="btn btn-info"><span class="fa fa-plus"></span> Add Lead</a>--}}
              </span>
                    @endcan
                    ...
                    @if(count($appointments) > 0)
                        <table id="example1" class="display responsive nowrap" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>Interested in Webinar Conversations</th>
                                <th>Note</th>
                                <th>Assigned To</th>
                                <th>Created By</th>
                                <!--<th>Email</th>
                            ...
                            @foreach($appointments as $appointment)
                                <tr>
                                    <td>
                                        @can('show-lead')
                                            <a href="{!! url('/leads/'.$appointment->lead->id); !!}">{{$appointment->lead->id}}</a>
                                        @else
                                            {{$appointment['id']}}
                                        @endcan
                                    </td>
                                    ...
                                    <td text="justify">{{ $appointment->note}}</td>
                                    ...
                                    <td><span class="text-green"><b>Interested in Webinar</b></span></td>
                                    @if(count($appointment->conversations) == null )
                                        <td>
                                            <a href="{!! url('leads/create_appointment_note/'.$appointment->lead_id.'/'.$appointment['id'].'' ); !!}"
                            ...
                            <tr>
                                <th>Lead No.</th>
                                <th>Interested in Webinar Date</th>
                                <th width="40%">Interested in Webinar Conversations</th>
                                <th>Note</th>
                                <th>Assigned To</th>
                                <th>Created By</th>
                                <!--<th>Email</th>
