...
@section('content')
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">Add Webinar Note for Lead : {{$lead->businessName}} ({{$lead->user->fname}} {{$lead->user->lname}})</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="{!! url('/leads/store_appointment_note'); !!}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body" >
                <div class="row">
