                ...
                <form class="form-horizontal" action="{!! url('appointmentfilter'); !!}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box box-success collapsed-box">
                        ...
                        <div class="box-footer clearfix">
                            <button type="submit" class="pull-right btn btn-primary" id="searchRecords">Search me
                    ...
                    @if(count($callbacks) > 0)
                        <table id="example1" class="display responsive nowrap" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>Appointments Conversations</th>
                                <th>Note</th>
                                <th>Assigned To</th>
                                <th>Created By</th>
                                <!--<th>Email</th>
                            ...
                            <tr>
                                <th>Lead No.</th>
                                <th>AppointmentsDate</th>
                                <th width="40%">Appointments Conversations</th>
                                <th>Note</th>
                                <th>Assigned To</th>
                                <th>Created By</th>
                                <!--<th>Email</th>
