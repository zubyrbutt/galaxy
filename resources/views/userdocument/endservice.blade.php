    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="{{route('endservice.store')}}" class="form" id="add_form" method="POST">
               @csrf   
...
<script type="text/javascript">
  var filterdata;
  var dataTableRoute = "{{ route('endservice.fetch') }}";
  var editRoute = "{{route('endservice.edit')}}";
  var activeRoute = "{{route('endservice.active')}}";
  var disableRoute = "{{route('endservice.disable')}}";
  var deleteRoute = "{{route('endservice.delete')}}";
