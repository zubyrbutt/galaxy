...
class RoleController extends Controller
{
    ...
    {
        $roles=\App\Role::with('createdby')->with('modifiedby')->get();
    ...
    public function create()
    {
        ...
        $menulist=\App\Adminmenu::wherenull('parentid')->with('children')->get();
        return view('roles.create',compact('menulist'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $allowed_menus=\App\Adminmenu::whereIn('id', $request->get('role_arr'))->get();
    ...
    {      
        ...
        if($role){
            ...
            return view('roles.edit',compact('role','menulist','permission','id'));
        }else{
            return redirect()->action('RoleController@index')->with('failed', 'Record not found.');
        }
    }
